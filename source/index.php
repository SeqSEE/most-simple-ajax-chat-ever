...
if(isSecure()){
	...
	if($user->ID < 0){
		...
		echo '<html>
    <head>
    <title>ShrugLabs Chat</title>
    </head>
    <body>
        <div id="content"><br/>
			<textarea id="chatwindow" rows="21" cols="50" style="resize: none;" readonly></textarea><br>
			<table>
				<tr><td></td></tr>
			</table>';
            echo '<input id="chatnick" type="text" size="9" maxlength="10" value="' . $user->nickname . '" readonly><br/>
            <input id="chatmsg" type="text" size="40" maxlength="50"  onkeyup="keyup(event.keyCode);" placeholder="message">
            <input type="button" value="send" onclick="submit_msg();" style="cursor:pointer;border:1px solid gray;"><br/><br/></div></body>
</html>
